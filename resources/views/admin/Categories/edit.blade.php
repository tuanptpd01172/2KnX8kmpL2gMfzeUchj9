...
<!-- 
 ...
 -->
	<?php
		...
		// echo '</pre>';
	 ?>
	 @if(isset($category) && count($category[0]->lang) > 0)
	 	@foreach($category[0]->lang as $detail)
	 		@if($detail->Locale == "vi")
	...
	@endif
	 ...
	 <div class="row">
	 		<div class="ibox">
	 			...
	 			{!! Helper::ss_flash()!!}	
		 			<form action="{{route('categories.update',$category[0]->id)}}" method="POST" enctype="multipart/form-data" >
		 				<div class="row">
			 					{{ csrf_field() }}
				                            ...
				                            <div id="tab-1" class="tab-pane active">
				                                <div class="panel-body">
				                                 	<div class="form-group">
					                                    ...
					                                    <input id="title_vi" type="text" placeholder="Tên Danh Mục..." class="form-control"  name="Name_vi" value="{{$vi_detail->pivot->Name}}">     
					                            	</div>
				                            ...
				                            <div id="tab-2" class="tab-pane">
				                                <div class="panel-body">
				                                	<div class="form-group">
					                                    ...
					                                    <input type="text" placeholder="Title" class="form-control"  name="Name_en" value="{{$en_detail->pivot->Name}}">     
					                            	</div>
			 					...
			 					<div class="col-md-5 ">
			 						...
			 						<label>Ảnh Category</label>
	                                    ...
	                                    <img src="{{'/public/upload/category/'.$category[0]->image}}" width="100%">   
		                            </div>
			 						
		                          	<div class="form-group">
		 								<label>Slug</label>
	                                    <input id="slug" type="text" placeholder="slug..." class="form-control"  name="Slug" value="{{$category[0]->Slug}}">  
	                            	</div>
		                            ...
		                            <div class="form-group">
				 						<label>Trạng Thái</label>
	                                        ...
	                                        <option value="0" @if(isset($category[0]->Status) && $category[0]->Status == 0){{'selected="selected"'}}@endif>Ẩn</option>
		                            ...
		                            <div class="form-group">
				 						<label>Danh Mục Cha</label>
	                                        ...
	                                        @if(isset($category_all) && count($category_all) > 0)
	                                        	{{Helper::gen_cate($category_all->toArray(),0,"",$category[0]->parent_id)}}
	                                        @endif
