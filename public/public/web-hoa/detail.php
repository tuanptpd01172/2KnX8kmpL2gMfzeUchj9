			...
			<div class="row">
				<div class="col-md-9">
					<div class="row">
						<div class="col-md-5" >
							<div class="l_item">
								<img src="http://wac.2f9ad.chicdn.net/802F9AD/u/joyent.wme/public/wme/assets/ec050984-7b81-11e6-96e0-8905cd656caf.jpg?v=30" alt="" width="100%">
								<span class="ibadge inew"></span>
							</div>
						</div>
						<div class="col-md-7" >
							<div class="detail-product">
								<h1>GIỎ HOA TƯƠI - TÌNH KHÚC VÀNG</h1>
								<p>Những ngươi luôn sống bên bạn và trải qua vui buồn, khó khăn cùng bạn thì đó là những người đáng cho bạn trân trọng cũng như dành tình cảm trân quý nhất dành cho họ. Tựa như bản tình khúc vàng cất lên giúp cho tình cảm ấy càng thêm sâu sắc, bền bĩ cũng năm tháng mãi không nhạt nhòa theo màu thời gian. Thích hợp tặng sinh nhật, hẹn hò, kỉ niệm ngày cưới...</p>
								<ul class="benefit">
				                ...
				                <div class="panel-body">
				                    <div class="tab-content">
				                        <div class="tab-pane fade in active" id="tab1default">
				                        	<p>Giỏ hoa tươi Tình Khúc Vàng gồm các loại hoa:</p>
											<p>- Hoa hồng trứng gà</p>
											<p>- Hoa cát tường</p>
											<p>- Hoa thủy tiên</p>
											<p>- Hoa lá phụ khác</p>
											<p>* Shop HoaYeuThuong cam kết giao gấp trong vòng 2 giờ kể từ khi quý khách đặt xong sản phẩm hoa </p>
				                        </div>
				...
				<div class="col-md-3" >
					<div>
						<img src="images/dat-hoa-so-luong-lon.png" alt="" style="width: 100%;">
					</div>
				</div>
			</div>
		</div>
