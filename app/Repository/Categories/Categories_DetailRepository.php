...
* 
*/
class Categories_DetailRepository implements Categories_DetailInterface
{
	protected $model;
	
	public function __construct(Categories_Detail $Categories_Detail)
	{
		date_default_timezone_set('Asia/Ho_Chi_Minh');
		$this->model = $Categories_Detail;
