...
class Slide_DetailController extends Controller
{
    protected $model;

    public function __construct(Slide_DetailInterface $Slide_DetailInterface)
    {
    	$this->model = $Slide_DetailInterface;
    }
    ...
    public function Slide_Details(Request $data)
    {
