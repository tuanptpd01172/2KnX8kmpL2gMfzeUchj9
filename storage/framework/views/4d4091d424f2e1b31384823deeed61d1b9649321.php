			...
			<div class="row">
				<div class="col-md-9">
					<div class="row">
						<div class="col-md-5" >
							<div class="l_item">
								<img src="<?php echo e(asset('/public/upload/post').'/'.$result->Avatar); ?>" alt="" width="100%">
								<span class="ibadge inew"></span>
							</div>
							<div>
								<span class=""><span>Giá:</span><?php echo e($result->lang[0]->pivot->Price); ?></span>
								<span class=""><span>Giá(Sale):</span><?php echo e($result->lang[0]->pivot->Sale_Price); ?></span>
								<span class=""><span>Màu Sắc:</span><?php echo e($result->color->lang[0]->pivot->Name); ?></span>
								
							</div>
						</div>
						<div class="col-md-7" >
							<div class="detail-product">
								<h1><?php echo e($result->lang[0]->pivot->Title); ?></h1>
								<p><?php echo e($result->lang[0]->pivot->Short_Descriptions); ?></p>
								<ul class="benefit">
				                ...
				                <div class="panel-body">
				                    <div class="tab-content">
				                        <div class="tab-pane fade in active" id="tab1default">
				                        	<?php echo $result->lang[0]->pivot->Descriptions; ?>
