	                            ...
	                            <div class="form-group">
	                                ...
	                                <select class="form-control m-b" name="categories_id">
	                                	<?php if(count($category) > 0): ?>
	                                   	 <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item_cate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item_cate->id); ?>"><?php echo e($item_cate->categories_detail[0]->Name); ?></option>
